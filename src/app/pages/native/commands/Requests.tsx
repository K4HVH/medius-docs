...
+--------+--------+--------+--------+--------+--------+`}</pre>
      ...
      <div id="version" data-search-target>
        <Card>
          ...
          <div class="api-response-label">EXAMPLE</div>
          <p>Firmware <code>2.1.0</code>, protocol <code>2</code>:</p>
          <pre class="diagram">{`+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
| A5     | 06     | 00     | 05 00  | 00     | 02     | 02     | 01     | 00     | lo hi  |
+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
...
+--------+--------+--------+--------+--------+--------+--------------+--------+`}</pre>
      ...
      <div id="options" data-search-target>
        <Card>
          ...
          <pre class="diagram">{`+--------+--------+--------+--------+--------+--------+--------+--------+--------+
| A5     | 06     | 00     | 05 00  | 09     | 00     | 01     | 01     | 01     | ... CRC16
+--------+--------+--------+--------+--------+--------+--------+--------+--------+
| SOF    | TYPE   | SEQ    | LEN    | what   | id     | allow  | overcap| imperf |`}</pre>
        </Card>
      </div>
