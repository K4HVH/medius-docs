...
//   INFO  connect: medius::device: connected proto_ver=7 fw_major=3 fw_minor=3 fw_patch=1
...
//   INFO  connect: medius::device: connected proto_ver=7 fw_major=3 fw_minor=3 fw_patch=1`}</code></pre>
        </Card>
      </div>
...
//   {"level":"INFO","target":"medius::device","fields":{"message":"connected","proto_ver":7}}`}</code></pre>
        </Card>
      </div>
    </>
  );
