...
//   INFO  connect: medius::device: connected proto_ver=7 fw_major=3 fw_minor=4 fw_patch=0
...
//   INFO  connect: medius::device: connected proto_ver=7 fw_major=3 fw_minor=4 fw_patch=0`}</code></pre>
        </Card>
      </div>
