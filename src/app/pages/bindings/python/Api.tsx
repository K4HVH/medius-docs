        ...
        <Card>
          ...
          <table class="api-params">
            ...
            <tbody>
              ...
              <tr><td><code>dev.set_emit_pace(pace, force_hz=None)</code></td><td>Pick the pace (<code>EmitPace.learned()</code> / <code>.interval()</code> / <code>.fixed(hz)</code>) and the advertised rate (<code>force_hz</code>, None = the device's own). See <A href="/library/options">Options</A>.</td></tr>
              <tr><td><code>dev.set_render(mode, full)</code></td><td>Pick the texture (<A href="/bindings/python/types#rendermode"><code>RenderMode</code></A>) and whether the device's own motion is drawn by the model rather than relayed. Both ride one frame, so <code>full</code> is required rather than defaulted. See <A href="/library/options">Options</A>.</td></tr>
        ...
        <Card>
          ...
          <table class="api-params">
            ...
            <tbody>
              ...
              <tr><td><code>dev.query_render()</code></td><td><A href="/bindings/python/types#renderstatus"><code>RenderStatus</code></A>: the texture, whether the device's own motion goes through it, and whether a profile has armed.</td></tr>
