        ...
        <Card>
          ...
          <table class="api-params">
            ...
            <tbody>
              ...
              <tr><td><code>dev.set_emit_pace(pace, render=RenderMode.OFF, force_hz=None)</code></td><td>Pick the pace (<code>EmitPace.learned()</code> / <code>.interval()</code> / <code>.fixed(hz)</code>), the render mode (<code>RenderMode.OFF</code> / <code>.STOCK</code> / <code>.DESPIKED</code> / <code>.UNSMOOTHED</code>), and the advertised rate (<code>force_hz</code>, None = the device's own). See <A href="/library/options">Options</A>.</td></tr>
