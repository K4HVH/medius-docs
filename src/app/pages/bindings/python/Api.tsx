        ...
        <Card>
          ...
          <table class="api-params">
            ...
            <tbody>
              ...
              <tr><td><code>dev.set_emit_pace(pace, rendered=False, force_hz=None)</code></td><td>Pick the pace (<code>EmitPace.learned()</code> / <code>.interval()</code> / <code>.fixed(hz)</code>), whether to render the texture, and the advertised rate (<code>force_hz</code>, None = the device's own). See <A href="/library/options">Options</A>.</td></tr>
