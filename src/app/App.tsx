...
import CmdImperfect from './pages/native/commands/Imperfect';
...
import LibImperfect from './pages/library/Imperfect';
    ...
    <NotificationProvider>
      <DashboardProvider>
        ...
        <Route path="/" component={DocsLayout}>
          ...
          <Route path="/native/commands/imperfect" component={CmdImperfect} />
          ...
          <Route path="/library/imperfect" component={LibImperfect} />
